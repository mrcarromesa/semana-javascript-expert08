...
export default class MP4Demuxer {
  ...
  async run(stream, { onConfig, onChunk }) {
    ...
    this.#file.onError = (error) =>
      console.error("Something wrong on mp4Demuxer", error);
  ...
  // https://github.com/w3c/webcodecs/blob/main/samples/video-decode-display/demuxer_mp4.js#L62C3-L76C1
  #description({ id }) {
   ...
   */
  #init(stream) {
    // mp4 box nos obriga a dizer onde que devemos começar a ler
    let _offset = 0
